...
public class ProductMapper {
    ...
    public static Product toEntity(ProductDTO productDTO, PostDTO postDTO, ProductCategory category) {
        return new Product(GenereteID.generateIDProduct(), productDTO.getProductName(), productDTO.getType(), productDTO.getBrand(), productDTO.getColor(), productDTO.getNotes(), postDTO.getPrice(),category);
    }
}
